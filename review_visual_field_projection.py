...
CONFIGURATION FLAGS:
    MONKE: Choose monkey dataset ('ASHTON' or 'LICK')
...
MONKE = 'LICK'  # Options: 'LICK' or 'ASHTON'
    ...
    if USE_LITERATURE_VALUES:
        ...
        if params_file.exists():
            try:
                ...
                params = OPTIMIZED_WEDGE_PARAMS.get(MONKE, OPTIMIZED_WEDGE_PARAMS['LICK'])  # fallback
